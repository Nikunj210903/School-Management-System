...
<div>
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			<div class="griditem1">
			        <h1 align="left" style="color:#1A4167;">Admission</h1>
					<hr>
			<p style="font-size:25px; text-align:justify;">As a new session is going to start, the admission forms are available online, as well as on all working days, at the school reception. Please complete the form in all respects, including all the required documents.</p>

			<div id="id01" class="modal">
  <form class="modal-content " action="admission.php" method="post">
    ...
    <div class="container">
      <h4 align="left"><b>Email Id</b></h4>
      <input type="email" placeholder="Enter email" name="email" required pattern="\w{5,}" title="minimum 5 alphanumeric required">

       <h4 align="left"><b>Full name</b></h4>
      <input type="password" placeholder="Enter full name" name="fname" required>
        <h4 align="left"><b>City</b></h4>
      <input type="text" placeholder="city" name="city" required pattern="\w{3,}" title="minimum 3 alphanumeric required">
	  
	 <h4 align="left"><b>parrent contact</b></h4>
      <input type="text" placeholder="Enter parrent contact" name="pcontact" required pattern="\w{10,}" maxlength="10" title="minimum 10 alphanumeric required">
	   <h4 align="left"><b>Address</b></h4>
      <input type="text" placeholder="Enter address" name="address" required pattern="\w{10,}" title="minimum 10 alphanumeric required">
...
$standard=$_POST['std'];
$qry="INSERT INTO `preadmission`(`email id`, `full name`, `address`, `parrent contact`, `standard`, `city`) VALUES ('$email','$fullname','$address','$pcontact','$standard','$city')";
