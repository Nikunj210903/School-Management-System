...
<div>
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			<div class="griditem1">
			        <h1 align="left" style="color:#1A4167;">Student Detail</h1>
<hr>					
			<div id="id01" class="modal">
  <form class="modal-content " action="sdetail.php" method="post">
    ...
    <div class="container" >
      <h3 align="left"><b>Enter Rollno</b></h3>
      <input type="text" placeholder="Enter Rollnos" name="roll" required">

       <h3 align="left"><b>Enter Standard</b></h3>
      ...
      <button type="submit" name="submit">Submit</button>
			...
			<h3 align="left">Gallery</h3>
			       <div class="g13">
				   <img  style="width:80%"src="images/school.jpg">
				  </div>
				  <div class="g13">
				   <img style="width:80%" src="images/school.jpg">
				  </div>
