...
$con= mysqli_connect('localhost','root','','school');
	...
	$qry="select * from `postadmission` where `roll no`='$roll' and `standard`='$standard'";	
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			...
			<h2 align="right"><a href="admincontrol.php">Back</a></h2>
			        <h1 align="left" style="color:#1A4167;">Update Student detail</h1>
<hr>					
  ...
  <form class="modal-content " action="update2.php" method="post">
    ...
    <div class="container" >
      <h3 align="left"><b>Student roll no</b></h3>
      <input type="text" placeholder="Enter roll no" name="roll" required pattern="\w{5,}" title="minimum 5 alphanumeric required">

       <h3 align="left"><b>Standard</b></h3>
      <input type="text" placeholder="Enter standard" name="std" required pattern="\w+[^\.]" minlength="5" title="minimum 5 alphanumeric required">
