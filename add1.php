    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			...
			<h2 align="right"><a href="admincontrol.php">Back</a></h2>
			        <h1 align="left" style="color:#1A4167;">Insert student</h1>
			<hr>	
			<div id="id01" class="modal">
  <form class="modal-content " action="add1.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter full name" name="fname" required pattern="\w+[^\.]" minlength="5" title="minimum 5 alphanumeric required">
        <h4 align="left"><b>City</b></h4>
      <input type="text" placeholder="city" name="city" required pattern="\w{5,}" title="minimum 5 alphanumeric required">
	  
	 <h4 align="left"><b>parrent contact</b></h4>
      <input type="text" placeholder="Enter parrent contact" name="pcontact" required pattern="\w{5,}" maxlength="10" title="minimum 5 alphanumeric required">
	   <h4 align="left"><b>Address</b></h4>
      <input type="text" placeholder="Enter address" name="address" required pattern="\w{5,}" title="minimum 5 alphanumeric required">
      
    <h4 align="left"><b>Standard</b></h4>
      <input type="text" placeholder="Enter Standard" name="std" required pattern="\w{5,}" title="minimum 5 alphanumeric required">
	  
	   <h4 align="left"><b>Image</b></h4>
...
$qry="INSERT INTO `postadmission`(`roll no`, `full name`, `address`, `parrent contact`, `standard`, `city`,`image`) VALUES ('$rollno','$fullname','$address','$pcontact','$standard','$city','$img')";
