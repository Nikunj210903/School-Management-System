    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			...
			<h2 align="right"><a href="admincontrol.php">Back</a></h2>
			        <h1 align="left" style="color:#1A4167;"> Delete Student detail</h1>
<hr>					
			<div id="id01" class="modal">
  <form class="modal-content " action="delete1.php" method="post">
    ...
    <div class="container" >
      <h3 align="left"><b>Student roll</b></h3>
      <input type="text" placeholder="Enter Roll no" name="roll" required >

       <h3 align="left"><b>Standard</b></h3>
      <input type="text" placeholder="Enter Password" name="standard" required >
...
$con= mysqli_connect('localhost','root','','school');
	...
	$qry="delete from `postadmission` where `roll no`='$roll'and `standard`='$standard' ";
	...
	{
		echo "Record has deleted successfully";
	}
}
?>