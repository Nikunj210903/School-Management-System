...
<div>
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			<div class="griditem1">
			        <h2 align="left" style="color:#1A4167">Admission_Control</h2>
					<hr>
			<div id="id01" class="modal">
  <form class="modal-content " action="">
    <div class="imgcontainer">
      <h3 style="color:#1A4167">Admin Dashboard</h3>
	  <br>
	  <hr>
	  <br>
	  <br>
    ...
    <div class="container">
    <br>
     <p style="text-align:justify; text-align:center"><b><a href="add1.php">Insert Student</a></b>
      <br>
<br>
     <b><a href="update1.php">Update Student</a></b>
   <br>
   <br>
         <b><a href="delete1.php">delete Student</a>
      <br>
     <br>
	 <hr>
...
$pincode=$_POST['uname'];
$standard=$_POST['pass'];
$qry="insert into `reqstudent` values(`fullname`,`email`,`contact`,`address`,`pincode`,`standard`)";
