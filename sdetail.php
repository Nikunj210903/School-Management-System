...
<div>
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			<div class="griditem1">
			        <h2 align="left">Student Detail</h2>
...
?>		
  <form class="modal-content " action="update2.php" method="post">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter rollno" name="rollno" value="<?php if(isset($_POST['submit'])){echo $data['roll no'];} ?>" required pattern="\w{5,}" title="minimum 5 alphanumeric required">
	 ...
	 <h4 align="left"><b>parrent contact</b></h4>
      <input type="text" placeholder="Enter parrent contact" name="pcontact" required pattern="\w{5,}" value="<?php if(isset($_POST['submit'])){ echo $data['parrent contact'];}?>" title="minimum 5 alphanumeric required">
    ...
    <h4 align="left"><b>Standard</b></h4>
      <input type="text" placeholder="Enter Standard" name="stdd" value="<?php if(isset($_POST['submit'])){echo  $data['standard'];}?>" required pattern="\w{5,}" title="minimum 5 alphanumeric required">
