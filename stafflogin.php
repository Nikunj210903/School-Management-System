...
<div>
    ...
    <div id="div3">
		...
		<div class="gridcontainer1">
			<div class="griditem1">
			        <h2 align="left">Admission_login</h2>
			<div id="id01" class="modal">
  <form class="modal-content " action="stafflogin.php" method="post">
    ...
    <div class="container">
      <h4 align="left"><b>Username</b></h4>
      <input type="text" placeholder="Enter Username" name="uname" required pattern="\w{5,}" title="minimum 5 alphanumeric required">

      <h4 align="left"><b>Password</b></h4>
      <input type="password" placeholder="Enter Password" name="psw" required pattern="\w+[^\.]" minlength="5" title="minimum 5 alphanumeric required">
...
else
{
	...
	window.open('admincontrol.php','_self');
	</script>
